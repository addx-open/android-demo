...
public class ExampleUnitTest {
    ...
    public void sign() {
        ...
        boolean isProdTest = true;

        // 1.生成签名URL
        String tenantId = isProdTest ? "sdkdemo" : "paastest";
        String accessKey = isProdTest ? "Ock8kTHMs1yaH1V6m7wGU1" : "viVqluNTSOF50sly757fF7";
        String secretKey = isProdTest ? "tvgtHkSuQLm3+Fcu4piQDg==" : "N38Ywi2YR4qddOqXBjDRhQ";
        String baseUrl = isProdTest ? "https://api-us.vicohome.io" : "https://api-staging-us.vicohome.io";
