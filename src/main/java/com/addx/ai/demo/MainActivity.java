...
public class MainActivity extends BaseActivity {
    ...
    public void clickToCallDoorbell(View view) {
        DoorBellMonitor door = new DoorBellMonitor();
        if(!door.isRegisterPhoneAccount()){
            door.registerPhoneAccount();
        }else{
            door.addNewIncomingCall("5d0e8a1d0c60379224684decc2314b4f", null);
        }
    }
...
//        DeviceClicent.getInstance().queryAllSharedInfo(xxx);  仅查询请求列表
    ...
    protected void onResume() {
        super.onResume();
        A4xPermissionHelper.requestStoragePermissions(this, null);
    }
}
